export default {
  ...
  developer_user_permissions: {
    allow_send_question: 'Send questions',
    allow_answer_question: 'Answer questions',
    allow_like_question: 'Like or dislike answers',
    allow_follow_user: 'Add or remove followings',
    allow_block_user: 'Manage blocked accounts',
    allow_read_timeline: 'Read profile and question timeline',
    allow_delete_question: 'Remove questions',
    allow_read_notification: 'Read notifications',
    allow_delete_notification: 'Delete notifications',
    allow_read_waiting: 'Read waiting questions, muted or not',
    allow_pin_question: 'Manage profile pinned question',
    allow_read_relationship: 'Read blocked and followed accounts',
    allow_manage_blocked_words: 'Manage muted words',
  },

  // Explainations to permissions (end-user page):
  end_user_permissions: {
    allow_send_question: 'Send questions on your behalf',
    allow_answer_question: 'Answer questions for you',
    allow_like_question: 'Like answers for you',
    allow_follow_user: 'Follow or unfollow accounts',
    allow_block_user: 'Manage your blocked accounts',
    allow_read_timeline: 'See your profile and your question timeline',
    allow_delete_question: 'Delete your unanswered or answered questions',
    allow_read_notification: 'See your notifications',
    allow_delete_notification: 'Delete your notifications',
    allow_read_waiting: 'See your waiting questions, muted or not',
    allow_pin_question: 'Define or delete your pinned question',
    allow_read_relationship: 'See who you follow and block',
    allow_manage_blocked_words: 'Manage your muted words',
  },
